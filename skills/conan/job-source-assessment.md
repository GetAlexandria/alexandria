...
2. **Assess coverage by dimension**
   ...
   | WHY       | Product thesis rationale, decision history, constraints/tensions, "why not X" |
...
| -------------------- | --------------------------------------- | ---------------------------------------- |
| Thesis Orphan        | Product cards exist but no thesis doc   | Human provides product thesis rationale  |
