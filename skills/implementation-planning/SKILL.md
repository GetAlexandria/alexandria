...
- `${CLAUDE_PLUGIN_ROOT}/skills/implementation-planning/outcome-writer.md`
- `${CLAUDE_PLUGIN_ROOT}/skills/implementation-planning/ticket-writer.md`

#### 7a: Write outcome files

Read `${CLAUDE_PLUGIN_ROOT}/skills/implementation-planning/outcome-writer.md` for
