...
3. `/ax-revise-plan` updates the plan when those findings change what should happen next
4. `/ax-complete-plan` records what actually shipped
...
Do not use it to close out finished work. Use `/ax-complete-plan` for that.
