...
consumes:
  ...
  - surface-map: "__AX2_INPUT_SURFACE_MAP__" (optional — empty path or missing file means not provided)
  - users: "__AX2_INPUT_USERS__" (optional)
  - prior-brief: "__AX2_INPUT_PRIOR_BRIEF__" (optional — when present you are revising, not starting over)
